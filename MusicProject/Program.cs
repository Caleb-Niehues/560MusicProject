...
namespace MusicProject
{
    ...
    public delegate ReviewModel SaveReview(ReviewModel review);
    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            ReviewView.InitializeDelegates(controller.GetReviews, controller.FetchReview, controller.SaveReview);
